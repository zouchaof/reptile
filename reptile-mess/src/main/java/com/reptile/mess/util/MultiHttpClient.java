...
public class MultiHttpClient {
     ...
     */
    @Deprecated
    public String postMethod(String url,String body,String charset){
     ...
     * @return
     */
    public String postMethod(String url,Map<String,String> map,String charset){
        String html = "";
        if(httpClient == null){
            return html;
        }
    ...
    public String postMethodMoveUrl(String url,Map<String,String> map,String charset){
        return postMethod(url, map, charset,null);
    }

    public String postMethod(String url,Map<String,String> map,String charset,Map<String, String> headerMap){
        String html = "";
        if(httpClient == null){
            return html;
        }
     ...
     * @return
     */
    public String getMethod(String url,Map<String,String> map,String charset){
    ...
    private String httpEntity2String(HttpEntity httpEntity,String charset) throws UnsupportedOperationException, IOException{
        String html = "";
     ...
     * @return
     */
    public String mapToUrlString(Map<String, String> map,String charset){
     ...
     * @return
     */
    public Map<String,String> urlStringToMap(String body){
    ...
    public String urlEdit(String domain, String url) {
